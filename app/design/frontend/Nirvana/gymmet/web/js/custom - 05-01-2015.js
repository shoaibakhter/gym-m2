...
// Social Icon
   $('.socail_popup').hover( function(event){
        event.stopPropagation();
        $('.social_icon').slideToggle( "1000" );
    });
   // Social Icon End

// Cart Bag
$('.cart_bag').hover( function(event){
        event.stopPropagation();
        $('.gym-bag-popup').slideToggle( "1000" );
    });
    
 
$('.my_whishlist').hover( function(event){
        event.stopPropagation();
...
$('.Sign-Btn').hover( function(event){
        event.stopPropagation();
        $('.sign-drop-down').slideToggle( "1000" );
    });
...
$(document).click( function(){
 $('.social_icon').hide(500);
 $('.gym-bag-popup').hide(500);
$('.Drop_menu').hide(500);
$('.sign-drop-down').hide(500);
 });
}
});
