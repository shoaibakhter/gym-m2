...
jQuery(document).ready(function() {
    ...
    jQuery( ".sidemenu-common-sidebar" ).append( "<span class='sideclose'></span>" );
    jQuery(".sidemenu-common").click(function() {
      jQuery(".sidemenu-common-sidebar").addClass('active-show');
    });
    jQuery('.sideclose').click(function() {
        jQuery('.sidemenu-common-sidebar').removeClass('active-show');
    }); 
    jQuery( ".sidemenu-common-sidebar2" ).append( "<span class='sideclose'></span>" );
    jQuery(".sidemenu-common2").click(function() {
      jQuery(".sidemenu-common-sidebar2").addClass('active-show');
    });
    jQuery('.sideclose').click(function() {
        jQuery('.sidemenu-common-sidebar2').removeClass('active-show');
    }); 
});
