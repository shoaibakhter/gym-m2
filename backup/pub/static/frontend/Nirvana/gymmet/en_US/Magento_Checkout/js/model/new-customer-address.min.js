define(['underscore','Magento_Checkout/js/model/default-post-code-resolver'],function(_,DefaultPostCodeResolver){'use strict';return function(addressData){var identifier=Date.now(),countryId,regionId;countryId=addressData['country_id']||addressData.countryId;if(countryId){if(addressData.region&&addressData.region['region_id']){regionId=addressData.region['region_id'];}else if(countryId===window.checkoutConfig.defaultCountryId){regionId=window.checkoutConfig.defaultRegionId;}}else{countryId=window.checkoutConfig.defaultCountryId;regionId=window.checkoutConfig.defaultRegionId;}
